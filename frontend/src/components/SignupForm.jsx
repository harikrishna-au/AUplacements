    ...
    <div className="w-full max-w-md mx-auto px-4 py-6 sm:px-6 sm:py-8">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
        <div className="mb-6 sm:mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-3">Create Account</h2>
          <p className="text-sm sm:text-base text-gray-600">Join the AU Placements portal today</p>
        </div>
