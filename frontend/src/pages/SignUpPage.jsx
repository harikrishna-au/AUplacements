  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      <div className="grid lg:grid-cols-2 min-h-screen">
        ...
        <div className="hidden lg:flex flex-col justify-center items-center p-12 bg-gradient-to-br from-indigo-600 to-purple-600">
          <div className="max-w-lg text-white">
            <div className="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-3xl flex items-center justify-center mb-8">
              <span className="text-6xl">🎓</span>
            </div>
            <h1 className="text-5xl font-bold mb-6">AU Placements Portal</h1>
